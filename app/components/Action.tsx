...
const Action = () => {
  return (
    <section className='relative mt-10 md:border-yellow-400 border-4 h-[600px]'>
        <Image src={backgroundImage} alt='background image' className='w-full h-full object-cover' />
        <div className='absolute top-1/4 sm:top-1/4 left-20 sm:left-1/4 flex flex-col gap-5 sm:gap-7 text-center w-[300px] sm:w-[550px]'>
