...
const About = () => {
  return (
    <section className='flex justify-center gap-20 my-32'>
        <div className='w-[500px] flex flex-col items-center gap-16'>
            ...
            <div className=' flex flex-col items-center gap-6'>
                ...
                <p className='text-center text-gray-500 font-semibold'>Slate helps you see how many more days you need to work to reach your financial goal.</p>
